...
CChartDateTimeAxis::CChartDateTimeAxis()
 : CChartAxisDu(), m_strDTTickFormat(), 
...
bool CChartDateTimeAxis::GetNextTickValue(double dCurrentTick, double& dNextTick)
{
...
TChartString CChartDateTimeAxis::GetTickLabel(double TickValue)
{
...
long CChartDateTimeAxis::ValueToScreenDiscrete(double dValue)
{
