...
CChartStandardAxis::CChartStandardAxis()
 : CChartAxisDu(), m_dFirstTickValue(0), 
...
bool CChartStandardAxis::GetNextTickValue(double dCurrentTick, double& dNextTick)
{
...
long CChartStandardAxis::ValueToScreenDiscrete(double dValue)
{
...
TChartString CChartStandardAxis::GetTickLabel(double TickValue)
{
