...
COLORREF pSeriesColorTable[] = { 
	RGB(255,0,0), RGB(0,150,0), RGB(0,0,255), RGB(255,128,0), 
	RGB(128,0,128), RGB(128,128,0), RGB(255,0,255), RGB(64,128,128)};
...
CChartSerie* CChartCtrl::GetSerie(unsigned  uSerieId) const
{
	...
	TSeriesMap::const_iterator iter;
	iter = m_mapSeries.begin();
	pToReturn = iter->second;
	/*if (uSerieId == 0)
	{
	iter = m_mapSeries.find(uSerieId);
