...
protected:
	...
	**/
	virtual bool GetNextTickValue(double dCurrentTick, double& dNextTick) = 0;
	...
	**/
	...
	/**
		...
		@return the screen position of the value
	**/
	virtual long ValueToScreenDiscrete(double Value) = 0;
	//! Converts a value on the axis to a screen position.
	/**
		This function is called internally only when the axis is in 
	...
	**/
	virtual TChartString GetTickLabel(double TickValue) = 0;
