...
{
	this->m_recordId.SetValue(signalTestRecord.GetRecordTime());
	this->m_recordTime.SetValue(signalTestRecord.GetRecordTime());
	this->m_frequency.SetValue(signalTestRecord.GetFrequency());
	this->m_peakValue.SetValue(signalTestRecord.GetPeakValue());
	this->m_grossValue.SetValue(signalTestRecord.GetGrossValue());
...
void TbSignalTestRecordDao::GetTableFieldValues(TbSignalTestRecord &signalTestRecord)
{
	...
	signalTestRecord.GetSignal().SetSignalId(m_signalId.m_strValue);
}
